...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasRCC<BasicTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasRCC<BasicTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1
) const
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasRCC<BasicTurbulenceModel>::fw
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasRCC<BasicTurbulenceModel>::Fr1
(
...
// R-C correction
    ...
    (
        IOobject
        (
            "Fr1",//IOobject::groupName("Fr1", alphaRhoPhi.group()),
            this->runTime_.timeName(),
            this->mesh_,
            IOobject::MUST_READ,
            IOobject::AUTO_WRITE
...
// Compute rTilda 
    volScalarField D(sqrt(0.5*(symInnerProduct+w)));
    ...
    volScalarField rTilda(2.0*rT/D/D/D/D);
...
///////////////////
    ...
    (
     ...
     ==
        Cb1_*alpha*rho*Stilda*nuTilda_*Fr1//curvature correction
